...
export const API_PROVIDERS = [
  ...
  { id: 'nvidia-llm', name: 'NVIDIA NIM (LLM)', category: 'LLM', color: '#76B900' },
  { id: 'nano-banana', name: 'Nano Banana', category: 'Image', color: '#FFD700' },
  { id: 'flux', name: 'Flux', category: 'Image', color: '#7C3AED' },
  { id: 'nvidia-image', name: 'NVIDIA NIM (Image)', category: 'Image', color: '#76B900' },
  ...
  { id: 'nvidia-video', name: 'NVIDIA NIM (Video)', category: 'Video', color: '#76B900' },
